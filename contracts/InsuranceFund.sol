...
contract InsuranceFund is IInsuranceFund, Ownable, BlockContext, ReentrancyGuard, DecimalERC20 {
    ...
    // remove token , when has balance then swap to perp token.
    function removeToken(IERC20 _token) external onlyOwner {
        ...
        // exchange and transfer to the quoteToken with the most value. 
        // if no more quoteToken, buy protocol tokens
